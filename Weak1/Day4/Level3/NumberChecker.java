...
public class NumberChecker{
	...
	public static void main(String[]args){
		...
		System.out.println("largest And SecondLargest of digits are "+largestAndSecondLargest[0]+" and "+largestAndSecondLargest[1]);

		System.out.println("smallest And SecondSmallest of digits are "+smallestAndSecondSmallest[0]+" and "+smallestAndSecondSmallest[1]);
