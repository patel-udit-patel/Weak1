...
public class NumberChecker2 {
    ...
    //method for sum of square of digit of number
    ...
    // method for checking if number is harshad
    ...
    //method for checking frequency of digit
    ...
    public static void main(String[] args) {
        ...
        int sumOfDigit=sumOfDigit(number);      //calling method sumOfDigit
        double sumOfSquareOfDigit=sumOfSquareOfDigit(number);//calling method sumOfSquareOfDigit
        boolean checkHarshad=checkHarshad(number);  //calling method checkHarshad
        int[][]frequencyOfDigit=frequencyOfDigit(number); //calling method frequencyOfDigit
